...
@section('title', 'Tratamiento - ' . $mascota->nombre)
...
@section('content')
        ...
        <div class="card-body">
            <div class="row align-items-center">
                ...
                <div class="col-md-8 d-flex align-items-center">
                    <div class="mr-4">
                        <i class="fas fa-pills fa-3x text-success opacity-50"></i>
                    </div>
                    <div>
                ...
                <div class="col-md-4 text-md-right mt-3 mt-md-0">
                    <button class="btn btn-success btn-sm shadow-sm" style="pointer-events: none;">
    ...
    <!-- Tarjeta de Edición de Tratamiento -->
    <div class="card shadow-sm mb-4">
        <div class="card-header py-3 bg-white border-bottom-0 pt-4 pb-0">
            <h6 class="m-0 font-weight-bold text-success">
                <i class="fas fa-prescription-bottle-alt mr-2"></i>Tratamiento de la Consulta
            </h6>
        </div>
        <div class="card-body pt-3">
            <form id="tratamientoForm" action="{{ route('expedientes.consultas.tratamiento.update', [$mascota->id, $consulta->id]) }}" method="POST">
                @csrf
                @method('PUT')
                
                <div class="form-group mb-4">
                    <input type="hidden" name="tratamiento" id="tratamiento">
                    <div id="editor-container" style="height: 300px;">{!! old('tratamiento', $consulta->tratamiento) !!}</div>
                </div>
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var form = document.getElementById('tratamientoForm');
            form.onsubmit = function() {
                var html = quill.root.innerHTML;
                if (html === '<p><br></p>') {
                    html = '';
                }
                document.getElementById('tratamiento').value = html;
            };
        });
    </script>
@endsection
